            ...
            <NormalLayout headerLeft={<Ionicons name="chevron-back" size={22} onPress={() => navigation.goBack()} />} shadowShown={true} showNavMenu={true} route={route} navigation={navigation}>
                <View style={styles.container}>
                    <View style={styles.container2}>
                        <Text style={styles.heading}>Add New Jobs</Text>
                        ...
                        <ScrollView style={{ flex: 1 }}>
                            <View style={styles.jobBoxContainer}>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Tidy bedroom</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Unpack dishwasher </Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Tidy up toy-room</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Wash the dog</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Clean the car</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Put Rubbish bins </Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.jobBox} onPress={() => { setModal(true); setModalType("inputs") }}>
                                    <Text style={styles.jobBoxText}>Tidy bedroom</Text>
                                </TouchableOpacity>
                            ...
                            modalType === "done" && <View style={styles.modalContainer}>
                                ...
                                <View style={successModalStyles.successModalBottom}>
                                    <ImageBackground source={require("../../../assets/Rewards/ModalBg.png")} style={successModalStyles.successModalBottomBg}>
                                        <Text style={successModalStyles.successModalHeading}>Yooho! New Task Assigned</Text>
                                        <View style={successModalStyles.successModalBox}>
                                            <LinearGradient colors={["#FFB1D5", "#DA5793"]} style={successModalStyles.successModalBoxBg}>

                                                <View style={successModalStyles.successModalBoxImgBox}>
                                                    <Image source={require("../../../assets/CaptureWork/SuccessImg3.png")} style={successModalStyles.successModalBoxImg} />
                                                </View>

                                                <Text style={successModalStyles.successModalBoxHeading}>Task Assigned to</Text>

                                                <View style={{ flexDirection: "row", alignItems: "center", alignSelf: "center" }}>
                                                    <Image
                                                        source={require("../../../assets/Connect/ConnectFromContactImg1.png")}
                                                        style={{ width: 45, height: 45 }}
                                                    />
                                                    <Image
                                                        source={require("../../../assets/Connect/ConnectFromContactImg2.png")}
                                                        style={{ width: 45, height: 45 }}
                                                    />
                                                </View>

                                                <View style={{ alignSelf: "center", flexDirection: "row", alignItems: "center", marginVertical: 10 }}>
                                                    <Ionicons name="star" style={{ ...successModalStyles.successModalStarIcon, fontSize: 22, marginLeft: 2 }} />
                                                    <Ionicons name="star" style={{ ...successModalStyles.successModalStarIcon, fontSize: 22, marginLeft: 2 }} />
                                                    <Ionicons name="star" style={{ ...successModalStyles.successModalStarIcon, fontSize: 22, marginLeft: 2 }} />
                                                    <Ionicons name="star" style={{ ...successModalStyles.successModalStarIcon, fontSize: 22, marginLeft: 2, color: "#DA5793" }} />
                                                </View>
                                                ...
                                                <TouchableOpacity style={{ ...successModalStyles.successModalBtn, backgroundColor: "transparent", borderWidth: 1, borderColor: "#FFFFFF", marginTop: 15 }} onPress={() => { setModal(false); setModalType(null) }}>
                                                    <Text style={{ ...successModalStyles.successModalBtnText, color: "#FFFFFF" }}>Back to tasks</Text>
                                                </TouchableOpacity>
